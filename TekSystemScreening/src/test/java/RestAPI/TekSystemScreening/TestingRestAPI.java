...
public class TestingRestAPI {
	...
	static TestingRestAPI tpiObject;
	static String retry;
	...
	public void lastMethod() throws JsonMappingException, JsonProcessingException {
		...
		if (statusCode == 404 || statusCode == 400) {
			...
			System.out.println(
					"If you would like to try again? Please Enter Yes to Continue " + "Or Type Exit to see the Test Execution Results \n");
			Scanner sc = new Scanner(System.in);
			retry = sc.nextLine();
	...
	public static void main(String[] args) throws JsonMappingException, JsonProcessingException {
		...
		tpiObject.negativeTestCase01();
		tpiObject.negativeTestCase02();
